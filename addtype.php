...
<body bgcolor="#FFF4C1">
    ...
    <div class="box">
        <P Align="center">
            <font color="white" size=6 face="Microsoft JhengHei Light"><b>新增武器類別</b></font>
        </P>
        <form action="addty.php" method="POST">

            <P Align="center">
                <div style= "font-size: 16px; color: white; font-weight: light;" >輸入類別名稱</div><input type="text" class="button"  name="tname">
            </P>
