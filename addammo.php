...
<body bgcolor="#FFF4C1">
    ...
    <div class="box">
        <P Align="center">
            <font color="white" size=6 face="Microsoft JhengHei Light"><b>新增彈藥資料</b></font>
        </P>
        <form action="addam.php" method="POST">

            <P Align="center">
                <div style= "font-size: 16px; color: white; font-weight: light;" >輸入彈藥名稱</div><input type="text" class="button"  name="amname">
                <div style= "font-size: 16px; color: white; font-weight: light;" >輸入一組彈藥的數量</div><input type="number" class="button" min="0" name="quantity">
            </P>
