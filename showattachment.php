...
<body bgcolor="#FFF4C1">
	...
	<div class="box">
		<P Align="center">
			<font color="white" size="8" face="Microsoft JhengHei Light"><b>配件資料總覽</b></font>
		</P>
		<div class="wi">
			<?php
			include("conn.php");

			$SQL = "SELECT a.atname ,a.atusage  FROM attachments as a order by a.atname";
			$result = mysqli_query($link, $SQL);

			echo "<table border='1'>";
			echo "<tr><th>配件名稱</th><th>用途</th></tr>";
