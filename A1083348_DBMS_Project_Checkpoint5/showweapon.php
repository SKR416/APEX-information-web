...
<body bgcolor="#FFF4C1">
	...
	<div class="box">
		<P Align="center">
			<font color="white" size="8" face="Microsoft JhengHei Light"><b>武器資料</b></font>
		</P>
		<div class="wi">
			<?php
			include("conn.php");

			$SQL = "SELECT w.wname,w.HeadDmg,w.BodyDmg,w.LegsDmg,w.capacity,t.tname FROM weapon as w, type as t WHERE w.tid=t.tid  order by t.tname;";
