...
<body bgcolor="#FFF4C1">
    ...
    <div class="box">
        <P Align="center">
            <font color="white" size=6 face="Microsoft JhengHei Light"><b>新增配件</b></font>
        </P>
        <form action="addatt.php" method="POST">

            <P Align="center">
                <div style= "font-size: 16px; color: white; font-weight: light;" >輸入配件名稱</div><input type="text" class="button"  name="attname">
                <div style= "font-size: 16px; color: white; font-weight: light;" >輸入配件敘述</div><input type="text" class="button"  name="usage">
            </P>
