...
<body bgcolor="#FFF4C1">
    ...
    <div class="box">
        <P Align="center">
            <font color="white" size=6 face="Microsoft JhengHei Light"><b>新增武器可用配件</b></font>
        </P>
        <form action="addinstall.php" method="POST">
            ...
            <div style= "font-size: 16px; color: white; font-weight: light;" >選擇配件</div><select name='attachments' class="button">
            <div class="wi">
                <?php
                include("conn.php");
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<option value='" . $row["attid"] . "'>" . $row["atname"] . "</option>";
                }
